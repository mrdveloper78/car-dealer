...
import { successMessage } from '../../ToastMessage/ToastFunctions';
    ...
    return (
        <div
            ...
            flex items-center justify-center  w-full h-full
              bg-white rounded-xl mt-16 p-4'>

            <div
                className='w-[400px] h-auto bg-white  mt-16 p-4 border 
            border-golden rounded-xl'
            >
